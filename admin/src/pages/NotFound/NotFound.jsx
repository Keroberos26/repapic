    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex items-center justify-center flex-grow">
        <div className="w-[400px] text-center">
          <h3 className="text-[2rem] font-bold leading-[1.5] mb-4">Không tìm thấy trang!</h3>
          <p className="text-fade leading-[1.5]">
            Xin lỗi, chúng tôi không thể tìm thấy trang bạn đang tìm kiếm. Có lẽ bạn đã gõ nhầm URL? Hãy chắc chắn để
            kiểm tra chính tả.
          </p>
            ...
            <svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="BG" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
                  ...
                  <stop offset="100%" stop-color="#00A76F" stopOpacity="0"></stop>
                </linearGradient>
              </defs>
              <path
                fill="url(#BG)"
                ...
                opacity="0.2"
              ></path>
              <image href="/images/character_6.png" height="300" x="205" y="30"></image>
              <path
                fill="#FFAB00"
